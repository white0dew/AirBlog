...
import { IsEmptyString, mylog, truncateSummary } from "@/lib/utils";
...
export async function generateMetadata({ params }: Props): Promise<Metadata | undefined> {
    ...
    const modifiedAt = new Date(curArticle.updated || curArticle.date).toISOString()
    ...
    //     }
    //   })
    const description = IsEmptyString(curArticle.description ?? "") ? siteMetadata.description : truncateSummary(curArticle.description, 200)
