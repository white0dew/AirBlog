...
updated: '2024-09-28 12:59:50'
cover: 'https://cdn.nlark.com/yuque/0/2024/png/22382235/1727268604843-f2f506b7-7117-4c73-aec4-70ad9a7aed60.png'
description: '---tags: [''中等'',''贪心'',''字符串'',''力扣'']---题目给你一个下标从 0 开始的字符串 text 和另一个下标从 0 开始且长度为 2 的字符串 pattern ，两者都只包含小写英文字母。你可以在 text 中任意位置插入 一个 字符，这个插入的字符必须是 pattern[...'
tags:
  - 中等
  - 贪心
  - 字符串
