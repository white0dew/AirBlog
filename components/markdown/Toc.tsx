...
export default function Toc() {
    ...
    return (
        <div className="ml-5 ">
            <span className="text-lg font-semibold py-6 dark:text-white">文章目录</span>
            <div className="js-toc text-decoration-none break-words 
             no-underline
            underline-offset-[-1] text-decoration-none"></div>
        </div>
    );
}