...
updated: '2024-06-06 21:18:37'
description: '---nav_path: python---第一部分：Python 入门第一章：初识 Python Python 简介 Python 的历史与发展Python 的应用领域为什么选择 Python 安装与设置 安装 Python（Windows、macOS、Linux）配置环境变量安装 IDE（...'
nav_path: python
---
### 第一部分：Python 入门
