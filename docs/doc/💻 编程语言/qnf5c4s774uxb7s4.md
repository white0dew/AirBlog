...
updated: '2024-09-28 12:04:59'
cover: 'https://cdn.nlark.com/yuque/__mermaid_v3/3dfd7076e3fd2cae25db4b4ea5aa127b.svg'
description: '---nav_path: javais_nav: true2024年Java开发者学习路线图1. 基础知识1.1 Java语法变量、数据类型、运算符控制流程（if-else, switch, loops）方法和参数传递数组和字符串操作1.2 面向对象编程(OOP)概念类和对象继承、封装、多态抽...'
nav_path: java
is_nav: true
---
# 2024年Java开发者学习路线图
![](https://oss1.aistar.cool/elog-offer-now/137cfd1e392a950f8cbbd33566160b4f.svg)
